...
def main():
    ...
    hotels_nn_experiment.best_params = {'estimator__max_iter': 10, 'estimator__learning_rate_init': 0.005, 'estimator__hidden_layer_sizes': (512, 512), 'estimator__alpha': 0.0001, 'estimator__activation': 'relu'}
    hotels_nn_experiment.network_arc = (512, 512)
    hotels_nn_experiment.run()
    hotels_nn_experiment.best_params = {'estimator__max_iter': 10, 'estimator__learning_rate_init': 0.005, 'estimator__hidden_layer_sizes': (256, 256, 128, 128), 'estimator__alpha': 0.0001, 'estimator__activation': 'relu'}
    hotels_nn_experiment.network_arc = (256, 256, 128, 128)
    hotels_nn_experiment.run()
    ...
    accidents_nn_experiment.best_params = {'estimator__max_iter': 300, 'estimator__learning_rate_init': 0.005, 'estimator__hidden_layer_sizes': (512, 512), 'estimator__alpha': 0.0001, 'estimator__activation': 'relu'}
    accidents_nn_experiment.network_arc = (512, 512)
    accidents_nn_experiment.run()
    accidents_nn_experiment.best_params = {'estimator__max_iter': 300, 'estimator__learning_rate_init': 0.005, 'estimator__hidden_layer_sizes': (256, 256, 128, 128), 'estimator__alpha': 0.0001, 'estimator__activation': 'relu'}
    accidents_nn_experiment.network_arc = (256, 256, 128, 128)
    accidents_nn_experiment.run()
