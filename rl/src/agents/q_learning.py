# ai use statement: github copilot assisted with q-learning algorithm structure
...
class QLearning:
    """q-learning temporal difference learning (off-policy)."""
    ...
    def train(self) -> Dict:
        ...
        for episode in range(self.num_episodes):
            ...
            while not done:
                ...
                if self.discrete_states:
                    td_target = reward + self.gamma * np.max(self.Q[next_state_key]) * (1 - done)
